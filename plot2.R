...
# <plot2.R> : creat line graph of Global Active Power along with time
png("plot2.png", width = 480, height = 480)
x2 <- df_nec$Time
y2 <- df_nec$Global_active_power
plot(x = x2, y = y2, xlab= "", ylab= "Global Active Power (kilowatts)", type = "l")
dev.off()